          ...
          <div class="row m-b-sm m-t-sm">
            <div class="col-md-1">
              <a type="button" class="btn btn-white btn-sm"
                href="/tutors/CheckServlet?param=academy"> <i class="fa fa-refresh"></i> 刷新
              </a>
            </div>
            <div class="col-md-11">
              <form action="/tutors/CheckServlet?param=query&power=academy" method="post">
        ...
        <div class="modal-body">
          <form class="form-horizontal" id="dialogII"
            ...
            <div class="modal-footer">
              <input type="text" name="kind" value="academy" hidden="hidden"> <input
